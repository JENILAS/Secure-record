		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      	<ul class="nav navbar-nav mu-menu navbar-right">
                           <li><a href="Admin_Login_Action.jsp">Home</a></li>
                        <!--    <li><a href="Authorize_User.jsp">Authorize Police</a></li> -->
			...
			<div class="row">
				<div class="col-md-12">
					<div class="mu-featured-area" style="margin-top: -80px;">
					 <br><h2 style="margin-top: -100px;"><strong>View Police Detail</strong></h2><br>
    			...
    			<table>
                            ...
                            <tr>
                                ...
                                <%}
                                 ...
                                 %> 
                                  <td><a href="Authorize_Action.jsp?id=<%=r.getString("id")%>&&uname=<%=r.getString("uname")%>" style='color:darkgreen;font-weight: bold;'>Authorize</a></td>
                                <%}%>
