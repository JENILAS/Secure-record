							   ...
							   <div class="over_lay_agile_pages_w3ls">
								    <div class="registration">
											...
											<form action="Approval" method="POST">
                                                                                                ...
                                                                                                <input type="text" name="dname"     value="<%=dname%>"     placeholder="AuthorityName" required="">
                                                                                                <input type="text" name="filename"  value="<%=fname%>"     placeholder="filename" required="">
                                                                                                <input type="text" name="msg" placeholder="msg" required="">
                                                                                                <input type="num" name="Amount" placeholder="Amount" required="">
