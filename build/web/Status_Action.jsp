							   ...
							   <div class="over_lay_agile_pages_w3ls">
								    <div class="registration">
                                                                        ...
                                                                        <%
                                                                            ...
                                                                            String policy=request.getParameter("policynum");;
                                                                            Connection con=new database().fun();
                                                                            PreparedStatement p=con.prepareStatement("select policynum from insurance where name='"+pname+"' ");
                                                                            ResultSet r=p.executeQuery();
                                                                            if(r.next()){
                                                                                policy=r.getString("policynum");
                                                                            }
                                                                        %>
												<div class="signin-form profile">
													<h2>Approval  </h2>
													<div class="login-form">
											<form action="Approval2.jsp" method="POST">
