		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      	<ul class="nav navbar-nav mu-menu navbar-right">
                       ...
                       <!--     <li><a href="Add_Personal_Data.jsp">Add Personal Data</a></li>
                            ...
                            <li><a href="Appointment.jsp"> Upload Complaint</a></li>
			...
			<div class="row">
    			...
    			<table>
                            ...
                            <%
                                ...
                                PreparedStatement ps=con.prepareStatement("select * from upload2");
                            ...
                            <tr>
                                ...
                                <td><%=r.getString("akey")%></td>
                                <td><a href="Key_Request.jsp?id=<%=r.getString("uname")%>&&fname=<%=r.getString("filename")%>"><%=r.getString("status")%></a></td>
