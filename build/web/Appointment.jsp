		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      	<ul class="nav navbar-nav mu-menu navbar-right">
                         ...
                         <!--   <li><a href="Add_Personal_Data.jsp">Add Personal Data</a></li>
                            ...
                            <li><a href="Appointment.jsp"> Upload complaint files</a></li>
                                ...
                                text-align: center;
                                         ...
                                         3   <br>
                                            ...
                                            <form action="Data_Insert" method="POST" enctype="multipart/form-data">  
                                             ...
                                             <tr><td><input type="text" name="username" placeholder="uploaded by" required=""></td></tr>
                                            <tr><td>
                                            <select name="appoint">
                                            <option selected="" disabled>send to</option>
                                             ...
                                             <%}%>      
                                              ...
                                              <tr><td>Name of person        <input type="text" name="name" placeholder="name" required=""></td></tr>
						    <tr><td>Address of person    <input type="text" name="address" placeholder="address" required=""></td></tr>
                                                    <tr><td>Phone number of person<input type="text" name="phone" placeholder="phone number" required=""></td></tr>
                                                    <tr><td>Email of person      <input type="text" name="email" placeholder="email" required=""></td></tr>
