 ...
 * @author ADMIN
 */
public class Data_Insert extends HttpServlet {
    int hashh;
     String fna="";
    String fdo="",content="";
     String b1,b2,b3;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     //System.out.println("the value sixcwe"+m.size());
                    ...
                    //ps=con.prepareStatement("insert into upload (Name,address,phone,email,filename,username,uname) values('" +m.get(0) + "','" +m.get(1) + "','" +m.get(2) + "','" +m.get(3) + "','" +ms.get(0) + "','" +m.get(5) + "','" +m.get(6) + "')");
            // ps=con.prepareStatement("insert into upload(filename,username,name)values('" + ms.get(0) + "','" + m.get(0)+ "','" + m.get(1) + "')");
           
                    //'" + m.get(2) + "','" + m.get(3) + "','" + m.get(4) + "','" + m.get(5) + "'
                    
                    // ps=con.prepareStatement("insert into upload(filename,username,name,cname,address,phone,email)values('" + ms.get(0) + "','" + m.get(0)+ "','" + m.get(1) + "','" +m.get(2) +"','" +m.get(3) + "','" +m.get(4) + "','" +m.get(5) + "')");
