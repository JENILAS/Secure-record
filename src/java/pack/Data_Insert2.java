...
public class Data_Insert2 extends HttpServlet {
 ...
 try {           
            ...
            PreparedStatement ps = con.prepareStatement("insert into upload2(uname,dname,filename,cname,address,phone,email) "
                + "values('" + uname + "','" + dname + "','" + file+ "','" + cname+ "','" + address+ "','" + phone+ "','" + email+ "')");
                 ps.executeUpdate();
